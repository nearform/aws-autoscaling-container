...
module.exports = function (config, logger) {
  ...
  var createAutoScalingGroupAndGetParams = function (autoScalingGroupName, healthCheckType, launchConfigurationName, loadBalancerNames, vpcZoneIdentifier, tags, cb) {
    autoScalingParams(autoScalingGroupName, function (err, params) {
      if (err) {
        return cb(err);
      }
      if (params !== null) {
      ...
      createAutoScalingGroup(autoScalingGroupName, healthCheckType, launchConfigurationName, loadBalancerNames, vpcZoneIdentifier, tags, function (err, params) {
        if (err) {
          return cb(err);
        }
